...
import { Play, Phone, Mic, Settings, Users, Shield, Zap, LineChart, Handshake, Shrink, Rocket,Calendar } from "lucide-react";
  ...
  return (
    <>
      ...
      <section className="bg-[linear-gradient(to_right,#FEFFFF_0%,#EDF6FD_50%,#DFF2FE_100%)] py-16 md:py-24 px-6 md:px-12 overflow-x-hidden flex items-center min-h-[80vh]">
        <div className="max-w-8xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16 w-full">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-6">
              <a
                ...
                className="bg-primary text-white px-7 py-2 rounded-lg font-bold flex items-center gap-2 transition duration-300 transform hover:scale-105 active:scale-95 hover:shadow-[var(--shadow-glow)]"
              >
          ...
          >
            <div className="relative w-[105%] max-w-[780px] lg:max-w-[850px]">
      ...
      <section className="w-full py-16 md:py-24 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-[42px] font-bold text-heading mb-4">
            {homeData.heading}
          </h2>
          <p className="text-textcolor text-base md:text-lg leading-[1.4] mb-12 max-w-3xl mx-auto opacity-90">
            {homeData.subheading}
          </p>
      ...
      {/* Section 4: How Our Technology Works */}
      <section className="w-full py-16 md:py-24 px-6 md:px-12 bg-[#EDF6FD]">
        <div className="max-w-6xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-[42px] font-bold text-primary mb-4">
            {homeData.howItWorks.title}{" "}
            <span className="text-primary">
              {homeData.howItWorks.titleHighlight}
            </span>
          </h2>
          <p className="text-textcolor text-base md:text-lg leading-[1.4] max-w-3xl mx-auto opacity-90">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <motion.div
            ...
            style={{ willChange: "transform, opacity" }}
          >
            <div className="w-full max-w-[500px] rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <img
                src={techFlowImage}
          ...
          >
            {homeData.howItWorks.steps.map((step) => (
              ...
              >
                <span className="flex-shrink-0 w-9 h-9 rounded-full bg-sky-500 text-white font-bold flex items-center justify-center">
                  {step.number}
                </span>
...
<section className="w-full py-16 md:py-24 px-6 md:px-12 bg-[#F8FAFC]">
  <div className="max-w-6xl mx-auto text-center">
    <h2 className="text-3xl md:text-4xl lg:text-[42px] font-bold text-primary mb-4">
      ...
      <span className="text-primary">{homeData.whyItMatters.titleHighlight}</span>
    </h2>
    <p className="text-textcolor text-base md:text-lg leading-[1.4] mb-12 max-w-3xl mx-auto opacity-90">
    ...
    >
      {homeData.whyItMatters.cards.map((card) => {
        ...
        return (
          <motion.div
            key={card.title}
            className="bg-white border-x border-b border-slate-100 shadow-sm rounded-xl p-8 text-left transition-transform duration-300 hover:scale-105 hover:shadow-lg"
            variants={scaleFadeVariants}
            style={{ willChange: "transform, opacity" }}
          >
            <div className={`w-16 h-16 rounded-full ${card.iconBg} flex items-center justify-center mb-4 mt-2`}>
  <Icon className={`w-8 h-8 ${card.iconColor}`} />
</div>
            <h3 className="text-xl font-semibold text-heading mb-2">
              {card.title}
            </h3>
            <p className="text-textcolor text-md leading-relaxed opacity-90">
              {card.desc}
            </p>
          </motion.div>
        );
...
{/* Section 6: CTA */}
<section className="w-full py-16 md:py-24 px-6 md:px-12 bg-gradient-to-b from-sky-500 to-sky-300 text-center">
  <div className="max-w-4xl mx-auto">
    ...
    <div className="flex flex-wrap justify-center items-center gap-4">
        ...
        <a href={homeData.ctaSection.buttons.primary.link}
        className="bg-white text-sky-500 px-7 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105 active:scale-95"
      >
        {homeData.ctaSection.buttons.primary.text}
      </a>
      
        <a href={homeData.ctaSection.buttons.secondary.link}
        className="bg-white text-sky-500 px-7 py-3 rounded-lg font-semibold flex items-center gap-2 transition duration-300 transform hover:scale-105 active:scale-95"
      >
