...
>
  {/* ✅ Background image ab img tag se, high priority ke saath */}
  <img
    src={heroBg}
    alt=""
    fetchPriority="high"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="min-w-0 lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left lg:-mt-30">
            <m.div
              ...
              className="w-full"
            >
              <span className="inline-block uppercase tracking-[1px] font-bold text-primary text-xs sm:text-sm mb-4 wrap-break-word max-w-full">
                {textSlide.badge}
              </span>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.05] tracking-tight text-heading wrap-break-word">
                {textSlide.heading}
              </h1>

              <p className="mt-5 text-textcolor sm:text-base lg:text-lg text-sub leading-8 max-w-xl mx-auto lg:mx-0 wrap-break-word">
            ...
            >
              ...
              <Link
                ...
                className="shrink-0 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full border-2 border-primary text-gray-900 font-bold hover:shadow-(--shadow-glow) hover:scale-105 transition-all duration-300 whitespace-nowrap max-w-full"
              >
          ...
          <div className="min-w-0 lg:col-span-7 flex flex-col items-center mt-6 lg:mt-0">
            ...
            >
              <Link
                ...
                className="hover:shadow-(--shadow-glow) hover:scale-105 mt-6 lg:mt-8 inline-block px-7 py-3 rounded-full border-2 bg-white shadow-sm font-semibold text-gray-900 border-primary transition-all duration-300"
              >
