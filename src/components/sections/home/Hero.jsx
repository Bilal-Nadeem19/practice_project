...
export default function Hero() {
  ...
  return (
    <section
       id="hero"className="relative overflow-hidden bg-white min-h-[calc(100vh-80px)] flex items-center py-10 sm:py-14 lg:py-20"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-5 sm:px-8 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          {/* LEFT SIDE */}
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left lg:-mt-30">
            <motion.div
              key={`left-${mountKey}`}
            ...
            >
              <span className="inline-block uppercase tracking-[1px] font-bold text-primary text-xs sm:text-sm mb-4">
                {textSlide.badge}
              </span>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-[1.05] tracking-tight text-heading">
                {textSlide.heading}
              </h1>

              <p className="mt-5 text-textcolor sm:text-base lg:text-lg text-sub leading-8 max-w-xl mx-auto lg:mx-0">
            ...
            >
              ...
              <Link
                ...
                className="shrink-0 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full border-2 border-primary text-gray-900 font-bold hover:shadow-[var(--shadow-glow)] hover:scale-105 transition-all duration-300 whitespace-nowrap"
              >
          ...
          {/* RIGHT SIDE */}
          <div className="lg:col-span-7 flex flex-col items-center mt-6 lg:mt-0">
            <motion.div
              ...
              <div className="relative w-full rounded-xl overflow-hidden">
                {hero.slides.map((slide, index) => (
                  <motion.img
                    ...
                    className="w-full h-auto object-cover rounded-xl select-none block"
                    style={{
